...
namespace QLStore.Product
{
    ...
    public partial class ProductPage : Page
    {
        ...
        ObservableCollection<Detail_Product> products;
        Manage_Product dbProduct = new Manage_Product();
        
        public delegate void DelegatePickProductID(Detail_Product pro);
        ...
        public ProductPage(string Type)
        {
            ...
            Thread thread = new Thread(delegate ()
            {
                ...
                Dispatcher.Invoke(() =>
                {
                    ...
                    else lbsp.Visibility = Visibility.Hidden;
                    listviewShowProduct.ItemsSource = products;
                    ProgressBar.IsEnabled = false;
                    ProgressBar.Visibility = Visibility.Hidden;
                });
        ...
        {
            NavigationService.Navigate(new QuickAccess());
        }

        private void BtnQRCode_Click(object sender, RoutedEventArgs e)
        {

            QuickAccess scanned = new QuickAccess();
            NavigationService.Navigate(new QuickAccess());
        }
    }
