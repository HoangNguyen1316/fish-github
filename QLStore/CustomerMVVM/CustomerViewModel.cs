   ...
   public  class CustomerViewModel:baseViewModel
    {
        ...
        private Customer customerItem = new Customer();
        ...
        public ObservableCollection<Customer> ListCustomers
        {
            get
            {
                ...
                listCustomers = new ObservableCollection<Customer>(manage.Load_Customer());
        ...
        //private ObservableCollection<Type_product> productTypes = new ObservableCollection<Type_product>();
        ...
        public CustomerViewModel()
        {
            ...
            }, (p) =>
            {
                ...
                {
                    Customer cus = (Customer)CustomerItem;
